...
//  kialisaevPW2
//
//  Created by Кирилл Исаев on 30.10.2024.
//
...
extension UIView {
    ...
    func pinTop(_ anchor: NSLayoutYAxisAnchor) {
        translatesAutoresizingMaskIntoConstraints = false
    ...
    func pinBottom(_ anchor: NSLayoutYAxisAnchor) {
        translatesAutoresizingMaskIntoConstraints = false
    ...
    func pinLeft(_ anchor: NSLayoutXAxisAnchor) {
        translatesAutoresizingMaskIntoConstraints = false
    ...
    func pinRight(_ anchor: NSLayoutXAxisAnchor) {
        translatesAutoresizingMaskIntoConstraints = false
